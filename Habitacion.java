...
/* Informatica Avanzada - 2021 */
    ...
    public String getDescripcionLarga()
    {
        ...
        return lugar.getDescripcion() + "\nSe ha derramado " + derramado + "en el piso\n" + getStringDeSalidas() + getStringDeElementos();
    }
    ...
    public Habitacion getSalida (Salida direccion) throws AccionNoPermitidaException
    {
        ...
        if(salidas.get(direccion) == null){
            throw new AccionNoPermitidaException("No hay salida en la direccion " + direccion);
        }else {
